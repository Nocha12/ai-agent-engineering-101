...
5개 복합 작업 × 3조건 × 3회에 429 복구를 반영했습니다. 원래 실패를 포함한 실제 시도 61개를 CSV와 콘솔에 보존하고, 최종 45개 작업을 중복 없이 집계했습니다. 문서 생성 45/45, 필수 facts 통과 44/45, 정답 배정 17/45입니다. 보고서에는 재귀 도식, Smith 비교, 기본 실험과의 차이·품질 한계를 간결하게 적었습니다.
